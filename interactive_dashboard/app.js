...
function repositionDiverToNode(nodeId) {
  ...
  // 使用 getBoundingClientRect 拿到真實螢幕座標，再換算回容器的未縮放座標系
  const containerRect = container.getBoundingClientRect();
  const cubeRect = targetCube.getBoundingClientRect();
  const scale = containerRect.width / container.offsetWidth || 1;

  const targetX = (cubeRect.left - containerRect.left + cubeRect.width / 2) / scale;
  const targetY = (cubeRect.top - containerRect.top + cubeRect.height / 2) / scale;
...
const SHOP_SKINS_DATA = [
  // 🤿 身體服飾 (4款)
  { id: "body_rookie", cat: "body", catName: "🤿 身體裝備", name: "新手經典潛水服", price: 0, icon: "🤿", desc: "經典藍黑配色的入門潛水服" },
  { id: "body_tech", cat: "body", catName: "🤿 身體裝備", name: "科技極速深藍服", price: 5, icon: "⚡", desc: "流線型高科技深海戰服" },
  { id: "body_royal", cat: "body", catName: "🤿 身體裝備", name: "皇家復古黃銅服", price: 5, icon: "👑", desc: "重型黃銅尊爵頭盔防壓服" },
  { id: "body_duck", cat: "body", catName: "🤿 身體裝備", name: "歡樂黃色小鴨服", price: 5, icon: "🐥", desc: "親和力極高的小鴨造型潛水服" },

  // 🔦 手持裝備 (4款)
  { id: "hand_flashlight", cat: "hand", catName: "🔦 手持裝備", name: "探險防水手電筒", price: 5, icon: "🔦", desc: "照亮深海與對話邊界的防照手電筒" },
  { id: "hand_camera", cat: "hand", catName: "🔦 手持裝備", name: "深海防水相機", price: 5, icon: "📷", desc: "記錄心動瞬間與約會回憶的相機" },
  { id: "hand_trident", cat: "hand", catName: "🔦 手持裝備", name: "海神威嚴三叉戟", price: 5, icon: "🔱", desc: "象徵自信引導力與主導框架的三叉戟" },
  { id: "hand_net", cat: "hand", catName: "🔦 手持裝備", name: "無慾望漁網", price: 5, icon: "🕸️", desc: "網羅豐盛心態、無慾無求的無敵漁網" },

  // 🦶 腳部蛙鞋 (4款)
  { id: "fins_classic", cat: "fins", catName: "🦶 腳部蛙鞋", name: "經典黑色蛙鞋", price: 0, icon: "🦶", desc: "穩健推進的基礎黑色雙蹼蛙鞋" },
  { id: "fins_whale", cat: "fins", catName: "🦶 腳部蛙鞋", name: "雙尾鯨魚造型蛙鞋", price: 5, icon: "🐋", desc: "優雅划水的雙尾鯨魚特色蛙鞋" },
  { id: "fins_neon", cat: "fins", catName: "🦶 腳部蛙鞋", name: "發光霓虹夜光蛙鞋", price: 5, icon: "✨", desc: "暗處發出夢幻光芒的夜光蛙鞋" },
  { id: "fins_gold", cat: "fins", catName: "🦶 腳部蛙鞋", name: "尊爵黃金特爵蛙鞋", price: 5, icon: "🌟", desc: "耀眼無比的純金特爵尊榮蛙鞋" }
];
